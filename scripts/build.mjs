...
for (const f of ['src/main.js','src/spa.js','src/storage.js','src/scoring.js','src/scheduler.js','src/pwa.js','src/styles.css','src/content/questionBank.json','src/content/contentHealth.json']) await fs.copyFile(f, `dist/${f}`);
